...
class stockx:
    def headers(includeGraphQl: bool = True) -> dict:
        headers = {
            ...
            "x-stockx-device-id": "cdc9935d-cc2b-419c-9fd7-2f93b40aa96c",
            "x-stockx-session-id": "0bc52cbb-fdf8-42a9-8db1-d039e1a9ee6c"}
        if includeGraphQl:
            headers["apollographql-client-name"] = "Iron"
            headers["apollographql-client-version"] = "2023.03.12.03"
            headers["app-platform"] = "Iron"
            headers["app-version"] = "2023.03.12.03"
        headers[
            "cookie"] = "__cf_bm=mRzDYi97zqEsH9dIDymsia2bDg_Rw5tkD3PYa73B4Ac-1680182854-0-AQ5ptFaV7f+bty7fFULN/2ggD9s8xsmCpBCv41MpnA0X6RG1FrdDpO1OMY2fSWYlI5tGuziIUsRzsIg93V6Hii8=; _pxvid=a242778c-cefe-11ed-bc92-4255704d7654; pxcts=a242851b-cefe-11ed-bc92-4255704d7654; __pxvid=a250d95a-cefe-11ed-ab31-0242ac120003; stockx_device_id=6e580d86-3c2f-4ed3-b1ed-05d43a4ff44a; stockx_session=f2e7c6f2-4e25-465c-958f-5c96d145c6d6; language_code=en; stockx_selected_region=NL; __ssid=d13b7bdaa52efb832649eac4bc00bd7; ftr_blst_1h=1680183124464; rskxRunCookie=0; rCookie=onjgaqhyxsbrplbn6wh5mlfv5ng8x; forterToken=c35f8c5d766e422e8cc7d6bf2a438aab_1680183525932__UDF43-m4_13ck; stockx_preferred_market_activity=sales; stockx_homepage=electronics; lastRskxRun=1680183565808; stockx_session_id=c3ab8eb0-5d3c-4dff-92cf-5ac4581e35e8; stockx_product_visits=2; _pxde=684365530a08ed149bf3438a1534bd6d5aa7b7b5b1693dcb3c0c67a09335b0fa:eyJ0aW1lc3RhbXAiOjE2ODAxODM2MjM2MjYsImZfa2IiOjB9; OptanonConsent=isGpcEnabled=0&datestamp=Thu+Mar+30+2023+15:40:25+GMT+0200+(Midden-Europese+zomertijd)&version=202211.2.0&isIABGlobal=false&hosts=&consentId=934eae21-9473-4b46-a7ba-1143b376119e&interactionCount=1&landingPath=NotLandingPage&groups=C0001:1,C0002:0,C0004:0,C0005:0,C0003:0&AwaitingReconsent=false; _dd_s=rum=0&expire=1680184525778"
        return headers
    ...
    def browse(category: str, tag: str, tags: list = [], page: int = 1, limit: int = 40, autoReturnParse=True) -> requests.Response | dict | None:
        try:
    ...
    def filterFamily() -> list:
        ...
        for filter in stockx.allBrowseFilters():
            ...
            newCategory['children'] = [child['url']
                                       for child in filter['children']]
            ...
            if allBrowseFilters[filter]['children']:
                for child in allBrowseFilters[filter]['children']:
                    if child['name'] == "Brands":
                        newCategory['children'] = [x['algolia'].replace(" ", "-")
    ...
    def parseBrowse(responseJson: dict) -> dict:
        ...
        return {'totalPages': results['pageInfo']['total'], 'items': [node['node'] for node in results['edges']]}
        ...
        if browse and browse.get('items') is not []:
            ...
            try:
                for item in stockx.browse(category['parent'], child, limit=40*totalPages)['items']:
                    ...
                    newItem['lowestAsk'] = get(
                        item, "market", "bidAskData", "lowestAsk")
                    newItem['highestBid'] = get(
                        item, "market", "bidAskData", "highestBid")
                    newItem['lastSale'] = get(
                        item, "market", "salesInformation", "lastSale")
                    newItem['lastSaleDate'] = get(
                        item, "market", "salesInformation", "lastSaleDate")
                    newItem['amountSold'] = get(
                        item, "market", "deadStock", "sold")
                    newItem['averagePrice'] = get(
                        item, "market", "deadStock", "averagePrice")
